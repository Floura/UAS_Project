...
public class WindowFormBarang extends JFrame {
	...
	public WindowFormBarang(final Core core) {
		...
		JMenu menuUser = new JMenu(
				core.getLoggedInUser().isAdmin() ? "Manager " : "Kasir "
		...
		JMenu menuBarang = new JMenu("Daftar Product");
		JMenuItem miBarangCetak = new JMenuItem("Cetak Stok");
		...
		cbSupplier.setVisible(false);
		tfIDSupplier.setBounds(615, 95, 170, 25);
		...
		lbJudul = new JLabel ("<HTML><H2>Produk Jamu Herbal</H2></HTML>");
